...
func TestGenerateAll(t *testing.T) {
	...
	certMeta, err := NewCertMetaData(BasePath, EtcdBasePath, []string{"test.com", "192.168.1.2", "kubernetes.default.svc.local"}, "172.16.0.0/16", "master1", "10.88.88.88", "cluster.local")
	if err != nil {
		t.Error(err)
	}
